package com.example.carrillo.agenda;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ingresar.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                intent = new Intent(MainActivity.this, MainActivityForm.class);
        ...
        lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                AlertDialog.Builder informacion = new AlertDialog.Builder(MainActivity.this);
                informacion.setMessage("Titulo: " + notas.get((int) id).getTitulo() + "\n" +
                        ...
                        }).setTitle("Nota").setIcon(R.drawable.notebook).create();
                informacion.show();
            }
        });
    }
